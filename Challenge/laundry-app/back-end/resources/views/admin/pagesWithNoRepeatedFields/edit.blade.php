...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pagesWithNoRepeatedFiedl.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.pages-with-no-repeated-fields.update", [$pagesWithNoRepeatedFiedl->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
