...
This repository contains exercises for Codi students learning HTML, CSS and Git commands.
...
![Screenshot showing the fork button in GitHub](/Exercises/html-css-git-exercises/images/fork-start.png)

![Screenshot showing how to fork to your user account](/Exercises/html-css-git-exercises/images/fork-user-account.png)

![Screenshot showing the clone details](/Exercises/html-css-git-exercises/images/fork-clone.png)

![Screenshot showing the button to copy the clone details](/Exercises/html-css-git-exercises/images/fork-copy-url.png)
